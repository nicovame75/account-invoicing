...
This module extends the functionality of sale orders to support marking some
stock picking moves as "To refund in Sale Order" and to allow you to create
...
#. Set *Quantity* to a lower quantity that the sold one, and enable
   *To Refund*.
#. Press *Return > Validate > Apply*.
#. Return to the sale order.
#. Press *Create Invoice > Invoiceable lines > Create and View Invoices*.
#. The amount of the created invoice will be the difference between the sold
...
#. Go to *Sales > Sales Orders > Create*.
#. Choose a customer and add a product whose *Invoicing Policy* is *Delivered
   quantities*, and input that you are selling 20 units.
#. Confirm the sale.
#. Go to *Delivery > Validate > Apply*.
#. Return to the sale order.
#. Press *Create Invoice > Invoiceable lines > Create and View Invoices*.
#. The created invoice's amount is 20 units now.
#. Return to the sale order.
#. Go to *Delivery > Reverse*.
#. Set *Quantity* to 5, and enable *To Refund*.
#. Press *Return > Validate > Apply*.
#. Return to the sale order.
#. Press *Create Invoice > Invoiceable lines (deduct down payments) >
   Create and View Invoices*.
#. The created invoice's amount is -5 units now.
